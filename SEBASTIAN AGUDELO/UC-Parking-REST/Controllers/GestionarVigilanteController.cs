...
namespace UC_Parking_REST.Controllers
{
    ...
    [ApiController]
    public class GestionarVigilanteController : ControllerBase
    {
        IVigilanteDomain _VigilanteDomain = new VigilanteDomainImplementation(null);
        ...
        // GET api/values
        [HttpGet]
        public ActionResult<IEnumerable<VigilanteDomain>> Get()
        {
            return new JsonResult(this._VigilanteDomain.GetListaVigilantes());
        }
